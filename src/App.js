...
import PendingSeekerRequests from "./components/Admin/PendingSeekerRequests";
import PendingDonorRequests from "./components/Admin/PendingDonorRequests";
import DonateBlood from "./components/Donor/DonateBlood";
import RequestBlood from "./components/Seeker/RequestBlood";

function App() {
  const [alert, setAlert] = useState(null);
  document.body.style.backgroundImage =
    "url('https://img.freepik.com/free-vector/neutral-soft-abstract-watercolor-background_53876-97742.jpg')";
          ...
          <div className="container">
            <Routes>
              ...
              <Route
                exact
                path="/donorrequests"
                element={<PendingDonorRequests />}
              ></Route>
              <Route
                exact
                path="/seekerrequests"
                element={<PendingSeekerRequests />}
              ></Route>
               <Route
                exact
                path="/seeker/requestblood"
