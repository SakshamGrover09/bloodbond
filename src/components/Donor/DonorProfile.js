...
const DonorProfile = () => {
  ...
  const { updateDonorPassword, profile, getDonorProfile } = context;
  ...
  const handleSubmit = async (e) => {
    if (credentials.cpassword === credentials.password) {
      updateDonorPassword(credentials.password);
          ...
          <div className="col-md-4 border border-imp mg">
            ...
            <form onSubmit={handleSubmit}>
              <div className="form-group my-2">
                <label className="pp my-2" htmlFor="password">
                  <i class="fa-solid fa-unlock"></i> New Password
                </label>
                <input
                  type="password"
              ...
              <div className="form-group my-2">
                <label className="pp my-2" htmlFor="cpassword">
              ...
              <button type="submit" className="buttonn my-4 pp mx-6 ">
                Change Password{" "}
              </button>
            </form>
          </div>
